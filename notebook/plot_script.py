...
def plotter(file_name, model, data, title, ylabel, yticks = None, avg = 0):
    ...
    file_name += model
    file_name = file_name + "_avg" + str(avg) if avg > 0 else file_name    
...
plotter(file_name="letter", model=model_name, data=ari, title=None, ylabel="ARI Letters", xticks=0.78, avg=2)
